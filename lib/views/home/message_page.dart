...
//   final MqttService mqttService; // Instance MQTT
...
//       }
//       mqttService.publishMessage('AMC/topic', message);
//       print("Message envoyé via MQTT : $message");
//     } catch (e) {
//       print("Erreur lors de l'envoi du message via MQTT : $e");
//       _showSnackbar(context, "Erreur lors de l'envoi du message via MQTT : $e");
//     }
//   }
